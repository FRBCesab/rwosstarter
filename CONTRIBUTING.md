...
for us maintainers and smooth out the experience for all involved.
...
[Contributor Code of Conduct](https://github.com/FRBCesab/rwosstarter/blob/main/CODE_OF_CONDUCT.md).
...
`rwosstarter` uses the `lower_snake_case`.
...
[Issues](https://github.com/FRBCesab/rwosstarter/issues) that might help you. 
...
- Open a new [Issue](https://github.com/FRBCesab/rwosstarter/issues/new).
- Use the template [other_issue.md](https://github.com/FRBCesab/rwosstarter/blob/main/.github/ISSUE_TEMPLATE/other_issue.md).
...
for your bug or error in the [bug tracker](https://github.com/FRBCesab/rwosstarter/issues?q=label%3Abug).


### How do I submit a bug report?

We use [GitHub Issues](https://github.com/FRBCesab/rwosstarter/issues) to track 
bugs and errors. If you run into an issue with the project:

- Open a new [Issue](https://github.com/FRBCesab/rwosstarter/issues/new).
- Use the template [bug_report.md](https://github.com/FRBCesab/rwosstarter/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `rwosstarter`.
- Read the [documentation](https://frbcesab.github.io/rwosstarter/)
carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/FRBCesab/rwosstarter/issues) to see if 
...
[GitHub Issues](https://github.com/FRBCesab/rwosstarter/issues).

- Open a new [Issue](https://github.com/FRBCesab/rwosstarter/issues/new).
- Use the template [feature_request.md](https://github.com/FRBCesab/rwosstarter/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/FRBCesab/rwosstarter/compare).
